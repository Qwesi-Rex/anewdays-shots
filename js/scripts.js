            ...
            finished: function () {
              ...
              $(".split-slider .swiper-slide").each(function (index, element) {
                tlThumbs.to(
                  element,
                  1,
                  { x: 0, opacity: 1, delay: 0.5, ease: Power2.easeOut },
                  index * 0.03
                );
              });
              ...
              TweenMax.to(
                $(".centered-slider .swiper-slide-active").prev(),
                1,
                {
                  force3D: true,
                  scale: 1,
              ...
              TweenMax.to(
                $(".centered-slider .swiper-slide-active").next(),
                1,
                {
                  force3D: true,
                  scale: 1,
              ...
              TweenMax.to(
                $(".centered-slider .swiper-slide-active").prev().prev(),
                1,
                {
                  force3D: true,
                  scale: 1,
              ...
              TweenMax.to(
                $(".centered-slider .swiper-slide-active").next().next(),
                1,
                {
                  force3D: true,
                  scale: 1,
...
function FirstLoad() {
  ...
  $("a.ajax-link").on("click", function () {
    ...
    if ($("#showcase-holder").length > 0) {
      ...
      TweenMax.to(
        $(".split-slider .swiper-slide-active").next().next().next(),
        0.4,
        { force3D: true, x: -250, opacity: 0, delay: 0.15, ease: Power2.easeIn }
      );
      TweenMax.to(
        $(".split-slider .swiper-slide-active").next().next().next().next(),
        0.4,
        { force3D: true, x: -250, opacity: 0, delay: 0.2, ease: Power2.easeIn }
      );
    ...
    finished: function () {
      ...
      $(".split-slider .swiper-slide").each(function (index, element) {
        tlThumbs.to(
          element,
          1,
          { x: 0, opacity: 1, delay: 0.3, ease: Power2.easeOut },
          index * 0.03
        );
      });
        ...
        if (!$("#page-content").hasClass("light-content")) {
          if ($("#hero-bg-image").hasClass("light-content")) {
            if (scroll >= $("#hero").height() - 80) {
              $("#magic-cursor, #header-container").removeClass(
                "light-content"
              );
            } else {
      ...
      on: {
        init: function () {
          ...
          $(".split-slider a.ajax-link-project").on("click", function () {
            ...
            TweenMax.to(
              $(".swiper-slide-active").next().next().next().next(),
              0.4,
              {
                force3D: true,
                x: -250,
          ...
          $(".swiper-slide")
            .on("mouseenter touchstart", function () {
              if (!$(this).hasClass("active")) {
                ...
                counter = $(
                  '#counter-wrap span[data-slide-count="' + slide + '"]'
                );
...
function Sliders() {
  ...
  if ($(".text-carousel").length > 0) {
    $(".text-carousel").owlCarousel({
      ...
      nav: true,
      navText: [
        "<div class='prev-testimonial parallax-element'><i class='fa fa-chevron-left' aria-hidden='true'></i></div>",
        "<div class='next-testimonial parallax-element'><i class='fa fa-chevron-right' aria-hidden='true'></i></div>",
      ],
    });
  }
} //End Sliders
...
function PlayVideo() {
  if ($(".video-wrapper").length > 0) {
    ...
    $(window).on("scroll", function () {
      if ($(window).scrollTop() > playerTop + $(".video-wrapper").height()) {
...
window.addEventListener("DOMContentLoaded", function () {
  const contactSelect = document.getElementById("package-select");
  if (contactSelect) {
    const selectOpt = document.getElementById("select-opt");
    contactSelect.addEventListener("click", function () {
      if (selectOpt.classList.contains("active")) {
        selectOpt.style.maxHeight = 0;
        selectOpt.classList.remove("active");
      } else {
        selectOpt.classList.add("active");
        selectOpt.style.maxHeight = selectOpt.scrollHeight + "px";
      }
    });

    const opts = document.querySelectorAll("#select-opt label");
    opts.forEach(function (opt) {
      opt.addEventListener("click", function () {
        const optText = document.getElementById("opt-text");
        optText.innerText = opt.textContent;
      });
    });
  }
});
//DROPDOWN 2
window.addEventListener("DOMContentLoaded", function () {
  const propertyType = document.getElementById("service-type");
  var arrowDown2 = document.getElementById("arrowdown2");
  if (propertyType) {
    const selectOpt2 = document.getElementById("select-opt-2");
    propertyType.addEventListener("click", function () {
      if (selectOpt2.classList.contains("active")) {
        selectOpt2.style.maxHeight = 0;
        selectOpt2.classList.remove("active");
      } else {
        selectOpt2.classList.add("active");
        selectOpt2.style.maxHeight = selectOpt2.scrollHeight + "px";
      }
      arrowDown2.classList.toggle(".rotate-arrow");
    });

    const opts = document.querySelectorAll("#select-opt-2 label");
    opts.forEach(function (opt) {
      opt.addEventListener("click", function () {
        const optText = document.getElementById("opt-text2");
        optText.innerText = opt.textContent;
      });
    });
  }
